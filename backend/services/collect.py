...
def coletar_licitacoes_reais(max_paginas=10, tamanho=10, palavras_chave=None, number_days=None, prompt=""):
    ...
    for page in range(1, max_paginas + 1):
        ...
        for item in results:
            ...
            texto_analise = f"""
                ...
                {descricao}
            """
            classificacao = classify_licitacao(texto_analise, prompt)
            # print(classificacao)
